...
class AlunoClasseLicaoTrimestre
{
	var $conn;
	...
	*/
	...
	{
 	/*$sql = "select aclt.* ,a.aluno, c.idclasse, c.classe, l.idlicao, l.licao,t.idtrimestre,t.trimestre,t.ano from aluno_classe_licao_trimestre aclt
...
order by ano,trimestre,classe  ";
		...
		while ($row = pg_fetch_array($res))
		{
		   ...
		   $html.="<option value='".$row['0']."' ".$s." >".$row['classe']." - ".$row['licao']." - ".$row['trimestre']." - ".$row['ano']."</option> ";
	    }
		$html .= '</select>';
		return $html;	
	}
