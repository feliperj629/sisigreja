...
<?php
   ...
   $FORM_BACK = 'consebd.php';
	...
	require_once('../classes/classelicaotrimestre.class.php');
   ...
   $ClasseLicaoTrimestre= new ClasseLicaoTrimestre();
   $ClasseLicaoTrimestre->conn = $conn;
   ...
   if ( ($op=='A') && (!empty($id)) )
   {
   	   $ClasseLicaoTrimestre->getById($id);
				$idclasselicaotrimestre = $ClasseLicaoTrimestre->idclasselicaotrimestre;
				$idclasse = $ClasseLicaoTrimestre->idclasse;
			    $classe = $ClasseLicaoTrimestre->classe;
			    $siglaclasse = $ClasseLicaoTrimestre->siglaclasse;
			    $idlicao = $ClasseLicaoTrimestre->idlicao;
			    $siglaclasse = $ClasseLicaoTrimestre->siglaclasse;
			    $idtrimestre = $ClasseLicaoTrimestre->idtrimestre;
          ...
          <div class="col-lg-12"> 
            <div class="panel panel-default"> 
              ...
              <div class="panel-body"> 
                <div class="row"> 
                  <div class="col-lg-6"> 
                    <form role="form" name="frm" method="post"  id="frm" action="<?php echo $FORM_ACTION;?>">
                      <input type="hidden" name="op" id="op" value="<?php echo $op;?>">
                      <input type="hidden" name="fechar" id="fechar" value="s">
                      <input type="hidden" name="tipo" id="tipo" value="montaclasse">
				<div class="control-group"> 
                    <!--  
					  <div class="form-group"> 
						...
						-->
						<div class="form-group"> 
                          <label class="control-label" for="edtclasse">Classe/Turma</label>
                          <?php echo $Classe->listaCombo('edtidclasse', $idclasse, 'N', 'class= "form-control"');?>
						</div>
						
						<div class="form-group"> 
                          <label class="control-label" for="edttrimestre">Trimestre</label>
                          <?php echo $Trimestre->listaCombo('cmboxtrimestre', $idtrimestre, 'N', 'class= "form-control"');?>
						</div>
						<!--
						<div class="form-group"> 
                          <label class="control-label" for="edtsiglaclasse">Classe</label>
                          <?php //echo $Classe->listaCombo('cmboxclasse', $idclasse, 'N', 'class= "form-control"');?>
						</div>
						-->
						<div class="form-group"> 
                          <label class="control-label" for="edtlicao">Lição/Matéria</label>
                          <?php echo $Licao->listaCombo('cmboxlicao', $idlicao, 'N', 'class= "form-control"');?>
						</div>
...
**/
  ...
  function showalert(message,alerttype) {
	...
	function validaForm()
	{
	   r = true;
	   m = '';
	   if ((document.getElementById('edtidclasse').value == '') || (document.getElementById('cmboxtrimestre').value == '') || (document.getElementById('cmboxlicao').value == ''))
	   { 
	      r = false;
