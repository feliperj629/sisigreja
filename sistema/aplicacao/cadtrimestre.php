...
<?php
   ...
   $FORM_NAME = 'Trimestre';
   $FORM_ACTION = 'exec.trimestre.php';
   $FORM_BACK = 'constrimestre.php';
   ...
   {
   	   $Classe->getById($id);
				$idtrimestre = $Classe->idtrimestre;
			    $trimestre = $Classe->trimestre;
			    $conteudo = $Classe->conteudo;
			    $datainicio = $Classe->datainicio;
			    $datafim = $Classe->datafim;
			    $ano = $Classe->ano;
                ...
                <div class="row"> 
                  <div class="col-lg-6"> 
                    <form role="form" name="frm" id="frm" action="<?php echo $FORM_ACTION;?>">
                      ...
                      <input type="hidden" name="edtidtrimestre" id="edtidtrimestre" value="<?php echo $idtrimestre;?>">
                      <div class="control-group"> 
                        <div class="form-group"> 
                          <label class="control-label" for="edtnometrimestre">Trimestre</label>
                          <input class="form-control" name="edtnometrimestre" id="edtnometrimestre" value="<?php  echo $trimestre;?>">
                        </div>
						<div class="form-group"> 
                          <label class="control-label" for="edtconteudo">Conteúdo/Título Revista</label>
                          <input class="form-control" name="edtconteudo" id="edtconteudo" value="<?php  echo $conteudo;?>">
                        </div>
						<div class="form-group"> 
                          <label class="control-label" for="edtdatainicio">Data Inicio</label>
                          <input class="form-control" type="date" name="edtdatainicio" id="edtdatainicio" value="<?php echo $datainicio;?>">
                        </div>
						<div class="form-group"> 
                          <label class="control-label" for="edtdatafim">Data Final</label>
                          <input class="form-control" type="date" name="edtdatafim" id="edtdatafim" value="<?php echo $datafim;?>">
                        </div>
						<div class="form-group"> 
                          <label class="control-label" for="edtanotrimestre">Ano trimestre</label>
                          <input class="form-control" maxlength="4" name="edtanotrimestre" id="edtanotrimestre" value="<?php echo $ano;?>">
                        </div>
...
**/
  ...
  function showalert(message,alerttype) {
	...
	function validaForm()
	{
	   r = true;
	   m = '';
	   if ((document.getElementById('edtnometrimestre').value == '') )
	   { 
	      r = false;
