                ...
                <div class="row"> 
                  <div class="col-lg-6"> 
                    <form role="form" name="frm" id="frm" action="<?php echo $FORM_ACTION;?>">
                      ...
                      <input type="hidden" name="edtidclasselicaotrimestre" id="edtidclasselicaotrimestre" value="<?php echo $idclasselicaotrimestre;?>">                      <div class="control-group"> 
...
**/
  ...
  function showalert(message,alerttype) {
	...
	function validaForm()
	{
	   r = true;
	   m = '';
	   if ((document.getElementById('edtnomeclasse').value == '') || (document.getElementById('cmboxtrimestre').value == '') || (document.getElementById('cmboxlicao').value == ''))
	   { 
	      r = false;
