...
<?php
   ...
   $FORM_NAME = 'Professor';
   $FORM_ACTION = 'exec.professor.php';
   $FORM_BACK = 'consprofessor.php';
   ...
   {
   	   $Classe->getById($id);
				$idprofessor = $Classe->idprofessor;
			    $professor = $Classe->professor;
			    $telprofessor = $Classe->telprofessor;
			    $obsprofessor = $Classe->obsprofessor;	   
                ...
                <div class="row"> 
                  <div class="col-lg-6"> 
                    <form role="form" name="frm" id="frm" action="<?php echo $FORM_ACTION;?>">
                      ...
                      <input type="hidden" name="edtidprofessor" id="edtidprofessor" value="<?php echo $idprofessor;?>">
                      <div class="control-group"> 
                        <div class="form-group"> 
                          <label class="control-label" for="edtnomeprofessor">Nome Professor</label>
                          <input class="form-control" name="edtnomeprofessor" id="edtnomeprofessor" value="<?php  echo $professor;?>">
                        </div>
						<div class="form-group"> 
                          <label class="control-label" for="edttelprofessor">Telefone</label>
                          <input class="form-control" name="edttelprofessor" id="edttelprofessor" value="<?php  echo $telprofessor;?>">
                        </div>
						<div class="form-group"> 
                          <label class="control-label" for="edtobsprofessor">Obs</label>
                          <input class="form-control" name="edtobsprofessor" id="edtobsprofessor" value="<?php  echo $obsprofessor;?>">
                        </div>						
...
**/
  ...
  function showalert(message,alerttype) {
	...
	function validaForm()
	{
	   r = true;
	   m = '';
	   if ((document.getElementById('edtnomeprofessor').value == '') )
	   { 
	      r = false;
