...
header('Location: index.php?erro=1');
   ...
   $TABLE_NAME = 'licao';
	...
	class MyPag extends Paginacao
	{
		...
		function desenha($row){
			...
			$html = ' 
					  ...
					  <td nowrap><a href="cadlicao.php?op=A&id='.$row['idlicao'].'">'.$row['licao'].'</a></td>
	...
	$filtrolicao = $_REQUEST['edtfiltrolicao'];
	$cmboxordenacao = $_REQUEST['cmboxordenacao'];
	
	$filtroigreja = $_REQUEST['cmboxigreja'];

	$sql = "SELECT * FROM licao where idlicao = idlicao ";	
	
	$filtroopen = false;
	if (!empty($filtrolicao))
	{
		$sql.=" and licao ilike '%".$filtrolicao."%'";
		$filtroopen = true;
	}
    ...
    <div id="page-wrapper">
       ...
       <div id="page-wrapper">
        <div class="row">
		  ...
		  <div class="col-lg-12"> 
			<h1 class="page-header">Licaos da Escola Bilica Dominical</h1>
			<?php if ($retorno!='')	{ ?>
            ...
            <div id="collapseOne" class="panel-collapse collapse <?php if ($filtroopen==true){ echo "in";} else {echo "out";}?>"> 
              <div class="panel-body"> 
                <div class="row-fluid"> 
                  <div class="row"> 
                    <div class="col-lg-6"> 
                      <div class="input-group input-group-sm"> <span class="input-group-addon">Licao</span> 
                        <input type="text" class="form-control"  name="edtfiltrolicao" id="edtfiltrolicao" value="<?php echo $filtrolicao;?>">
                      </div>
                    </div>
                    <div class="col-lg-3"> 
                      <div class="input-group input-group-sm"> <span class="input-group-addon">Ordenado 
                        ...
                        <select name="cmboxordenacao" id="cmboxordenacao"  class="form-control" placeholder="Order">
                          ...
                          <option value="licao" <?php if ($cmboxordenacao=='licao') echo "selected";?> >Licao</option>
                           </select>
                      </div>
                    </div>
